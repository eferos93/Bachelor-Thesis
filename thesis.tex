...
\begin{enumerate}
	...
	\item due to the nature of the architecture, Jolie was the perfect programming language to be used for the implementation. I implemented the \textbf{completion} feature for keywords and operations, \textbf{hover} functionality for operations and  \textbf{diagnostics}, providing linting for errors in the code.
