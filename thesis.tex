...
\begin{enumerate}
	...
	\begin{enumerate}
		...
		\item modifying \verb|JsonRpcProtocol| class in order to handle the aforementioned messages;
	\end{enumerate}	 
