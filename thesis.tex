...
\chapter{Validation}
Validation is a process in which the software is tested in order to check if the requirements are satisfied. 
\begin{table}[H]
	\caption{Functional Requirements}
	\begin{tabularx}{\textwidth}{c|X}
		\hline
