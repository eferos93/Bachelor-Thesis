...
\begin{align*}
	...
	|& \, foreach(c : t)\> \quad (foreach child in tree)\\
	|& \, B_1 \, ; \, B_2 \quad (sequential)\\
	|& \, B_1 \, | \, B_2 \quad (parallel)\\
	|& \, \{\, B \,\} \quad (block)\\
	|& \, x\,=\,e \quad (assign)\\
	|& \, [\,\eta_1\,]\>\{\,B_1\,\}\,...\,[\,\eta_n\,]\>\{\,B_n\,\} \quad (inputChoice)
\end{align*}
where
\begin{align*}
