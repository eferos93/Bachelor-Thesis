...
In this section we will see two architectures according to NFR 4. One architecture, represents the system with the Language Server deployed in the same machine as the development tool, while the other describes the architecture of the system when the Language Server is deployed in a different machine than the client.
\begin{figure}[t]
