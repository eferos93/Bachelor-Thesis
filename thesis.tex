...
\end{lstlisting}
Given a text document URI and position, the text document referred is sent by the Utils service, subsequently, the line of code of interest is extract and saved in a variable (lines 9-12). Lines 16-23 permits to extract information from the code line reffered by the text document position. 
\chapter{Validation}
